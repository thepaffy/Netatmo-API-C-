...
TEST(NAHCCApiClientTest, requestHomeCoachsDataTest) {
    NAHCCApiClient client;
    ...
    EXPECT_NO_THROW(client.login("read_homecoach"));

    EXPECT_NO_THROW(client.requestHomeCoachsData());
}
